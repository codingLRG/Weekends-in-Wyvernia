...
tags:
  - session
---
> Night Midi-Fore of Calm
# To Do List
- [ ] [[Totentaz Bridge]]
	> [[Martha Strout]] snuffs out her torch light and requests the same to be done for the party. A broken wheel barrel cart illuminated by torchlight lies dead center of this cobble stone bridge. The sound of the icy river rages under the overhang, and essence of arguing is carried in the air. 
	- [ ] Bridge Combat Encounter - Hard (180 XP each)
		- Actors
			- [[Champion of Gorm]]
			- [[Champion of Usamigaras]]
		- Scene Uniqueness
			- Bridge battle at night with blockade
		- Stakes Amplifier
			- The cart has a timed explosive that will cause a free cast fireball in 4 turns after being lit
				- This will destroy the bridge
			- Fire will instantly ignite the carriage
		- Panic Button
			- Hound caged is a [[Gibbering Mouther]]
		- Loot
			- [ ] 5 GP
- [ ] [[Farafel]] introduction
...
- [ ] Dinner with the Captain [[Niketas O'Neill]]
	...
	- [ ] Hold Person
	- [ ] Eat [[Leche]]
	- [ ] You are now my dog, and you will be until you sniff out my uncle
